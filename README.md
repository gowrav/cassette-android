[Cassette for Android](cassette-android)  [![Build Status](https://ci.popcorntime.sh/job/Popcorn-Time-Android/badge/icon)](https://ci.popcorntime.sh/job/Popcorn-Time-Android/)
----

Allow any Android user to listen audiobooks easily streaming from torrents, without any particular knowledge.

Visit the project's website at <http://gowrav.com/project-cassette>.
Reference https://github.com/popcorn-official/popcorn-android

* [Continuous Integration]()
* [Issue Tracker](https://github.com/gowrav/cassette-android/issues)
...
Copyright (c) 2020 Cassette - Released under the [GPL V3 license].
